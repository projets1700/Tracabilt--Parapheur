    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--fond-page)' }}>
      <div style={{ width: '100%', maxWidth: 400, padding: '0 20px' }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ color: 'var(--texte2)', marginTop: 4, fontSize: 13 }}>Système de traçabilité QR + GPS</p>
        </div>
        ...
        <div className="carte" style={{ padding: 24 }}>
          <form onSubmit={handleSoumettre}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              <div>
                <label className="label-champ">Identifiant (email)</label>
                <input
                  className="champ"
                  type="email"
              ...
              <button className="btn btn-primaire" type="submit" disabled={envoi} style={{ width: '100%', justifyContent: 'center', padding: 11 }}>
          ...
          <div style={{ textAlign: 'center' }}>
            <p style={{ fontSize: 12, color: 'var(--texte3)', marginBottom: 8 }}>Accès sans compte</p>
        ...
        <div style={{ marginTop: 16, background: 'white', border: '1px solid var(--bordure)', borderRadius: 10, padding: '12px 16px' }}>
          <p style={{ fontSize: 11, color: 'var(--texte3)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: 8 }}>Comptes de démo</p>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
            <p style={{ fontSize: 12, color: 'var(--texte2)' }}><strong>Admin :</strong> admin@organisation.fr / admin123</p>
            <p style={{ fontSize: 12, color: 'var(--texte2)' }}><strong>Opérateur :</strong> j.martin@organisation.fr / operateur123</p>
          </div>
        </div>
      </div>
    </div>
